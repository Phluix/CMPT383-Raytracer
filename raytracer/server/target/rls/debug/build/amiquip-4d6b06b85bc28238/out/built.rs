...
pub const PKG_VERSION: &str = "0.3.3";
...
pub const PKG_AUTHORS: &str = "John Gallagher <johnkgallagher@gmail.com>";
#[doc="The name of the package."]
pub const PKG_NAME: &str = "amiquip";
#[doc="The description."]
pub const PKG_DESCRIPTION: &str = "Pure Rust RabbitMQ client";
#[doc="The homepage."]
...
pub const FEATURES_STR: &str = "DEFAULT, NATIVE_TLS";
/// The output of `rustc -V`
pub const RUSTC_VERSION: &str = "rustc 1.45.2 (d3fb005a3 2020-07-31)";
/// The output of `rustdoc -V`
pub const RUSTDOC_VERSION: &str = "rustdoc 1.45.2 (d3fb005a3 2020-07-31)";
...
pub const BUILT_TIME_UTC: &str = "Mon, 17 Aug 2020 22:08:41 +0000";
